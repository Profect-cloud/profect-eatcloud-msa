...
import profect.eatcloud.domain.globalCategory.repository.BaseCategoryRepository;
...
public class GenericCategoryService {
	...
	private BaseCategory newEntity(String type) {
		return switch (type) {
			case "store-categories" -> new profect.eatcloud.domain.globalCategory.entity.StoreCategory();
			case "menu-categories" -> new profect.eatcloud.domain.globalCategory.entity.MenuCategory();
			// 다른 카테고리는 여기에 추가
