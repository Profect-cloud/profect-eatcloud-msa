package com.eatcloud.userservice.customer.controller;
...
import com.eatcloud.userservice.customer.message.ResponseMessage;
import com.eatcloud.userservice.customer.service.AddressService;
...
public class AddressController {
	...
	public com.eatcloud.userservice.common.ApiResponse<List<AddressResponseDto>> getAddressList(
		...
		return com.eatcloud.userservice.common.ApiResponse.success(addresses);
	}
	...
	public com.eatcloud.userservice.common.ApiResponse<List<AddressResponseDto>> createAddress(
		@AuthenticationPrincipal UserDetails userDetails,
		@Valid @RequestBody AddressRequestDto request) {
		UUID customerId = getCustomerUuid(userDetails);
		AddressResponseDto response = addressService.createAddress(customerId, request);
		return com.eatcloud.userservice.common.ApiResponse.created(Collections.singletonList(response));
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public com.eatcloud.userservice.common.ApiResponse<List<AddressResponseDto>> updateAddress(
		@AuthenticationPrincipal UserDetails userDetails,
		@PathVariable UUID addressId,
		@Valid @RequestBody AddressRequestDto request) {
		UUID customerId = getCustomerUuid(userDetails);
		AddressResponseDto response = addressService.updateAddress(customerId, addressId, request);
		return com.eatcloud.userservice.common.ApiResponse.success(Collections.singletonList(response));
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public com.eatcloud.userservice.common.ApiResponse<ResponseMessage> deleteAddress(
		@AuthenticationPrincipal UserDetails userDetails,
		@PathVariable UUID addressId) {
		UUID customerId = getCustomerUuid(userDetails);
		addressService.deleteAddress(customerId, addressId);
		return com.eatcloud.userservice.common.ApiResponse.success(ResponseMessage.ADDRESS_DELETE_SUCCESS);
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public com.eatcloud.userservice.common.ApiResponse<ResponseMessage> setDefaultAddress(
		@AuthenticationPrincipal UserDetails userDetails,
		@PathVariable UUID addressId) {
		UUID customerId = getCustomerUuid(userDetails);
		addressService.setDefaultAddress(customerId, addressId);
		return com.eatcloud.userservice.common.ApiResponse.success(ResponseMessage.ADDRESS_SELECT_SUCCESS);
	}
