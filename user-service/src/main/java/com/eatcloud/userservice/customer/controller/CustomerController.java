...
import com.eatcloud.userservice.customer.dto.request.CustomerProfileUpdateRequestDto;
import com.eatcloud.userservice.customer.dto.request.CustomerWithdrawRequestDto;
import com.eatcloud.userservice.customer.dto.response.CustomerProfileResponseDto;
...
import com.eatcloud.userservice.customer.service.CustomerService;
...
public class CustomerController {
	...
	public com.eatcloud.userservice.common.ApiResponse<CustomerProfileResponseDto> getCustomer(
		...
		return com.eatcloud.userservice.common.ApiResponse.success(response);
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public com.eatcloud.userservice.common.ApiResponse<ResponseMessage> updateCustomer(
		@AuthenticationPrincipal UserDetails userDetails,
		@Valid @RequestBody CustomerProfileUpdateRequestDto request) {

		UUID customerId = getCustomerUuid(userDetails);
		customerService.updateCustomer(customerId, request);
		return com.eatcloud.userservice.common.ApiResponse.success(ResponseMessage.PROFILE_UPDATE_SUCCESS);
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public com.eatcloud.userservice.common.ApiResponse<ResponseMessage> withdrawCustomer(
		@AuthenticationPrincipal UserDetails userDetails,
		@Valid @RequestBody CustomerWithdrawRequestDto request) {

		UUID customerId = getCustomerUuid(userDetails);
		customerService.withdrawCustomer(customerId, request);
		return com.eatcloud.userservice.common.ApiResponse.success(ResponseMessage.CUSTOMER_WITHDRAW_SUCCESS);
	}
}